...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_dir', default='/workspace/PS-FCN/datasets/PS_Blobby_Dataset')
        self.parser.add_argument('--data_dir2', default='/workspace/PS-FCN/datasets/PS_Sculpture_Dataset')
        ...
        self.parser.add_argument('--init_lr', default=2e-3, type=float)
