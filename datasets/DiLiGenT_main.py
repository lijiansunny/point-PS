...
if __name__ == '__main__':
    # normal = imread('DiLiGenT/pmsData/ballPNG/Normal_gt.png')
    # mask = imread('DiLiGenT/pmsData/ballPNG/mask.png')
    # print(normal.shape)
    # print(mask.shape)
    objs = util.readList(os.path.join('E:/PhotometricStereo/PS-FCN/datasets/DiLiGenT/pmsData', 'objects.txt'),
                         sort=False)
